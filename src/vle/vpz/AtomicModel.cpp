...
void AtomicModel::purgeDynamics(const std::set<std::string>& dynamicslist)
{
...
void AtomicModel::purgeObservable(const std::set<std::string>& observablelist)
{
...
void AtomicModel::purgeConditions(const std::set<std::string>& conditionlist)
{
