...
#ifndef VLE_GRAPH_COMPOSENT_MODEL_HPP
#define VLE_GRAPH_COMPOSENT_MODEL_HPP
...
namespace vle { namespace vpz {
     ...
     */
    class VLE_API Component : public BaseModel
    {
    public:
        /**
        ...
        Component(const Component& mdl);

        Component& operator=(const Component& mdl);
         ...
         */
        friend std::ostream& operator<<(std::ostream& out, const Component& a)
        {
            out << "conditions: ";
		...
		vpz::MultiComponent* getContainer(){return m_container;}
		std::string getContainerName();
        //inline
       /* devs::SimulatorMulti* get_simulator() const noexcept
        {
            return m_container->get_simulator();
        }
		*/
     ...
     //   friend devs::SimulatorMulti;
        ...
        vpz::MultiComponent* m_container;
