...
#include <vle/devs/AbstractSimulator.hpp>
...
public:
    ...
    SimulatorMulti *addMulticomponent(vpz::MultiComponent *model);
    //
    ///
    //// Get/Set functions.
    ///
...
private:
    ...
    std::vector<std::unique_ptr<Simulator>> m_simulators; //changement ici
